...
class HeaderWithoutDrawer extends Component {
  state = {}
    ...
    return (
      <View style={[styles.menu, {height:Platform.OS=='ios'? 90:55,}]}>
        <View style={{ flex: 1, flexDirection: 'row', backgroundColor: Theme.PRIMARY_COLOR, paddingTop: Platform.OS=='ios'?40:0 }}>
          <TouchableOpacity style={{ flex: 0.15, alignItems: 'center', justifyContent: 'center', }} onPress={this.props.onBack}>
...
export default connect(mapStateToProps, null)(HeaderWithoutDrawer);
