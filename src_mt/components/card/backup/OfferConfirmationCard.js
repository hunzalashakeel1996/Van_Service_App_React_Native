...
const OfferConfirmationCard = (props) => {
        ...
        <View style={{ flex: 1, }}>
            {props.platform === 'android' ? <TouchableNativeFeedback>
                ...
                <View style={[styles.container, data.isNew == 'true' ? styles.isNew : styles.borderShadow]}>
                    <View style={{ height: hp(10), flexDirection: "row", justifyContent: "center" }}>
                    ...
                    {/* {props.cardButton && <View style={{ height: hp(8), marginHorizontal: 10, flexDirection: "row", alignItems: "center" }}>
                        {props.cardButton && <View style={{ flex: 1, }}>
                            <Button onPress={() => props.cardButton()} styleButton={{ alignSelf: "flex-end", height: 35, width: 100 }} styleText={{ fontSize: Theme.FONT_SIZE_MEDIUM }} >{props.cardButtonText}</Button>
                        </View>}
                    </View>} */}
                </View>
                {props.cardButton && <View style={{ height: hp(8), marginHorizontal: 10, flexDirection: "row", alignItems: "center" }}>
...
const mapStateToProps = state => {
  ...
  export default connect(mapStateToProps)(OfferConfirmationCard);
